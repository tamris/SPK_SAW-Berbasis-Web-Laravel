...
class AlternatifKriteriaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Cek duplikasi penilaian untuk alternatif ini
        $existingPenilaian = AlternatifKriteria::where('alternatif_id', $request->alternatif_id)->first();
        if ($existingPenilaian) {
            return redirect()->back()->with('error', 'Penilaian untuk alternatif ini sudah ada.');
        }
